# DigiCard - create and apply the RemoveTermehTemplate migration.
# Run from the Package Manager Console:   .\run-migration.ps1
# Log: migration4-log.txt
#
...
$log = Join-Path $PSScriptRoot 'migration4-log.txt'
...
$migration = Invoke-Step "create migration RemoveTermehTemplate" {
    dotnet ef migrations add RemoveTermehTemplate --context TemplatesDbContext --project ".\src\Modules\DigiCard.Modules.Templates" --startup-project ".\src\DigiCard.DbMigrator" --output-dir "Infrastructure\Migrations"
}
