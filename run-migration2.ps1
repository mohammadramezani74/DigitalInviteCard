# DigiCard - create and apply the TemplateArtwork migration.
# Run from the Package Manager Console:   .\run-migration.ps1
# Log: migration2-log.txt
#
...
$log = Join-Path $PSScriptRoot 'migration2-log.txt'
...
$migration = Invoke-Step "create migration TemplateArtwork" {
    dotnet ef migrations add TemplateArtwork --context TemplatesDbContext --project ".\src\Modules\DigiCard.Modules.Templates" --startup-project ".\src\DigiCard.DbMigrator" --output-dir "Infrastructure\Migrations"
}
