# DigiCard - create and apply the TemplateDesignTokens migration.
...
$log = Join-Path $PSScriptRoot 'migration-log.txt'
...
$migration = Invoke-Step "create migration TemplateDesignTokens" {
    dotnet ef migrations add TemplateDesignTokens --context TemplatesDbContext --project ".\src\Modules\DigiCard.Modules.Templates" --startup-project ".\src\DigiCard.DbMigrator" --output-dir "Infrastructure\Migrations"
}
