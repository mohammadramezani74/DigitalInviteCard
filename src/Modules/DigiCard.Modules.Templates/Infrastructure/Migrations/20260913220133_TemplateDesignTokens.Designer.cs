...
namespace DigiCard.Modules.Templates.Infrastructure.Migrations
{
    ...
    [Migration("20260913220133_TemplateDesignTokens")]
    partial class TemplateDesignTokens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigiCard.Modules.Templates.CardTemplate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a41a6319-3438-4ef9-89da-fae6b30b010a"),
                            Accent = "#8c3b3b",
                            Background = "linear-gradient(180deg,#fbf3ee 0%,#f3e4dc 100%)",
                            Category = "aghd",
                            Family = "persian",
                            Frame = "ornate",
                            Ink = "#3a2424",
